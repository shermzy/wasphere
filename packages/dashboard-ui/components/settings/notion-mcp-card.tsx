      ...
      <Card className="border-primary/20 [background-image:radial-gradient(hsl(var(--primary)/0.04)_1px,transparent_1px)] [background-size:20px_20px]">
        ...
        <CardContent className="flex flex-col gap-5">
          ...
          <ol className="grid gap-3 text-sm text-muted-foreground">
            ...
            <li><span className="font-medium text-foreground">4.</span> Choose header-based authentication in Notion. Set the header name to <code className="text-xs text-foreground">Authorization</code> and the value to <code className="text-xs text-foreground">Bearer &lt;full wsk_ key&gt;</code>, without quotes. The key is shown once.</li>
